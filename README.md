...
[![Tests](https://github.com/openedx-actions/tutor-k8s-configure-mysql/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-k8s-configure-mysql/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Configure remote MySQL service
        uses: openedx-actions/tutor-service-configure-mysql@v1.0.3
        with:
